...
**Features**
  ...
  * Includes convenient [Spectator](https://github.com/icy-arctic-fox/spectator) integration with metadata support.
...
The docs come in two flavors:
  ...
  * See the [CHANGELOG](https://github.com/alexanderadam/vcr/blob/master/CHANGELOG.md) doc for info about what's new and changed.
...
**Development**
  ...
  * Source hosted on [GitHub](https://github.com/alexanderadam/vcr).
  * Direct questions and discussions on [GitHub Issues](https://github.com/alexanderadam/vcr/issues).
  * Report bugs/issues on [GitHub Issues](https://github.com/alexanderadam/vcr/issues).
  * Pull requests are very welcome! Please include spec coverage for every patch,
    and create a topic branch for every separate change you make.
  * See the [Contributing](https://github.com/alexanderadam/vcr/blob/master/CONTRIBUTING.md)
